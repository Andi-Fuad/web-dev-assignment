        ...
        <div class="card-body">
            ...
            <form method="POST" action="save" enctype="multipart/form-data">
                <div class="mb-4 row text-black">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="nim" class="form-control" placeholder="Input NIM Anda"
                            required="required">
                    </div>
                </div>
                ...
                <div class="mb-4 row text-black">
                    ...
                    <div class="col-sm-9">
                        <textarea name="alamat" class="form-control" placeholder="Input Alamat Anda"
                ...
                <div class="mb-4 row text-black">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="file" id="formFile" name="foto" required="required">
                    </div>
                </div>
